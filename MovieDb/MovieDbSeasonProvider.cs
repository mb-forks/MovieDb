    ...
    public class MovieDbSeasonProvider : IRemoteMetadataProvider<Season, SeasonInfo>
    {
        ...
        public async Task<MetadataResult<Season>> GetMetadata(SeasonInfo info, CancellationToken cancellationToken)
        {
            ...
            if (!string.IsNullOrWhiteSpace(seriesTmdbId) && seasonNumber.HasValue)
            {
                try
                {
                    var seasonInfo = await GetSeasonInfo(seriesTmdbId, seasonNumber.Value, info.MetadataLanguage, info.MetadataCountryCode, cancellationToken)
        ...
        internal Task EnsureSeasonInfo(string tmdbId, int seasonNumber, string language, string preferredMetadataCountry, CancellationToken cancellationToken)
        {
            ...
            return DownloadSeasonInfo(tmdbId, seasonNumber, language, preferredMetadataCountry, cancellationToken);
        }
        ...
        internal async Task DownloadSeasonInfo(string id, int seasonNumber, string preferredMetadataLanguage, string preferredMetadataCountry, CancellationToken cancellationToken)
        {
            var mainResult = await FetchMainResult(id, seasonNumber, preferredMetadataLanguage, preferredMetadataCountry, cancellationToken).ConfigureAwait(false);
        ...
        internal async Task<RootObject> FetchMainResult(string id, int seasonNumber, string language, string preferredMetadataCountry, CancellationToken cancellationToken)
        {
            ...
            var includeImageLanguageParam = MovieDbProvider.GetImageLanguagesParam(language, preferredMetadataCountry);
