...
namespace MovieDb
{
    public abstract class MovieDbProviderBase
    {
        ...
        protected async Task<RootObject> GetEpisodeInfo(string seriesTmdbId, int season, int episodeNumber, string preferredMetadataLanguage, string preferredMetadataCountry,
            CancellationToken cancellationToken)
        {
            await EnsureEpisodeInfo(seriesTmdbId, season, episodeNumber, preferredMetadataLanguage, preferredMetadataCountry, cancellationToken)
        ...
        internal Task EnsureEpisodeInfo(string tmdbId, int seasonNumber, int episodeNumber, string language, string preferredMetadataCountry, CancellationToken cancellationToken)
        {
            ...
            return DownloadEpisodeInfo(tmdbId, seasonNumber, episodeNumber, language, preferredMetadataCountry, cancellationToken);
        }
        ...
        internal async Task DownloadEpisodeInfo(string id, int seasonNumber, int episodeNumber, string preferredMetadataLanguage, string preferredMetadataCountry, CancellationToken cancellationToken)
        {
            var mainResult = await FetchMainResult(EpisodeUrlPattern, id, seasonNumber, episodeNumber, preferredMetadataLanguage, preferredMetadataCountry, cancellationToken).ConfigureAwait(false);
        ...
        internal async Task<RootObject> FetchMainResult(string urlPattern, string id, int seasonNumber, int episodeNumber, string language, string country, CancellationToken cancellationToken)
        {
            ...
            var includeImageLanguageParam = MovieDbProvider.GetImageLanguagesParam(language, country);
